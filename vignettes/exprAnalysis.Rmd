...
net = blockwiseModules(datExpr,checkMissingData = TRUE,corType="bicor", # or pearson
                       maxBlockSize=10000,networkType="signed",power=softpower,minModuleSize=30,maxPOutliers = 0.1,
                       mergeCutHeight=mergingThresh,numericLabels=TRUE,saveTOMs=TRUE,randomSeed = 12345,
...
```{r wgcna_wgcna_heatmaps, eval=TRUE}
data(MEs)
```
