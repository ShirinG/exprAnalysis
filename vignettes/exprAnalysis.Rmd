...
Beware that the vignette is rather large and thus takes a minute to compile. You can also see the Vignette at [https://shiring.github.io/rna-seq/microarray/2016/09/28/exprAnalysis](https://shiring.github.io/rna-seq/microarray/2016/09/28/exprAnalysis).
...
```{r module_plot_ggplot, echo=FALSE, include=FALSE, eval=FALSE, fig.width=10, fig.height=15}
