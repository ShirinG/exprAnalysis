...
corrgram::corrgram(Ctrl_cor, order=TRUE, lower.panel=panel.pie,
...
p = ggplot2::ggplot(results, aes(log2FoldChange, -log10(pvalue))) +
  ggplot2::geom_point(aes(col=sig)) +
  ggplot2::scale_color_manual(values=c("red", "black")) +
  ggplot2::ggtitle("Volcano Plot of DESeq2 analysis")

p+ggrepel::geom_text_repel(data=results[1:10, ], aes(label=rownames(results[1:10, ])))
