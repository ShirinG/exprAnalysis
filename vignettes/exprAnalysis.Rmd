...
celfiles <- list.files(dir, recursive = TRUE)[grep(".*CEL$", list.files(dir, recursive = TRUE), ignore.case = TRUE)]
...
quality_control_plots(eset, groupColumn=character(0))
...
# Optional: Remove outlier samples and repeat
```
